...
function App() {
	...
	const [currentPage, setCurrentPage] = useState("main"); // "main" or "taskManager"

	const switchToMainPage = () => {
		setCurrentPage("main");
	};

	const switchToTaskManagerPage = () => {
	...
	return (
		<>
			<div className="flex justify-between p-4 bg-gray-800 text-white">
				<button onClick={switchToMainPage}>Frontend UI</button>
				<button onClick={switchToTaskManagerPage}>Task Manager</button>
			</div>
