...
describe("ezbase tests", () => {
    ...
    test("createCollection", async () => {
        ...
        // console.log(cct1);
        expect(cct1).toBeDefined("Collection created successfully"); // add appropriate expectations
    });
    ...
    test("getCollections", async () => {
        ...
        const collections = await eb.db.getAllCollections();
        // console.log(collections);
        expect(collections).toBeDefined(); // add appropriate expectations
    });
    ...
    test("createRecord", async () => {
        ...
        const result = await eb.db.createRecord("TestSDKCollection1", { "name": "John Doe" });
        // console.log(result);
        expect(result).toBeDefined(); // add appropriate expectations
    });

    // 5) Test for readRecord
    test("readRecord", async () => {
        console.log("Testing reading a single field document");
        const result = await eb.db.readRecord("TestSDKCollection1", { "name": "John Doe" });
        // console.log(result);
        expect(result).toBeDefined(); // add appropriate expectations
    });
    ...
    test("deleteRecord", async () => {
        ...
        const result = await eb.db.deleteRecord("TestSDKCollection1", { "name": "John Doe" }, true);
        // console.log(result);
        expect(result).toBeDefined(); // add appropriate expectations
    });
    ...
    test("listRecords", async () => {
        ...
        const result = await eb.db.listRecords("TestSDKCollection1", {}, {});
        // console.log(result);
        expect(result).toBeDefined(); // add appropriate expectations
    });
    ...
    test("countRecords", async () => {
        ...
        const result = await eb.db.countRecords("TestSDKCollection1", { "name": "John Doe" });
        // console.log(result);
        expect(result).toBeDefined(); // add appropriate expectations
    });
});
